...
- Use dynamic variables such as `{guild-name}`, `{author-icon}`, and [more](https://docs.swiftbot.site/miscellaneous/variables#giveaway-variables)
...
<Note>
If you've encountered any bugs, feel free to report them to us in the [#bugs-report](https://discord.com/channels/1275507213783535707/1275507219286458505) channel.
</Note>
</Update>